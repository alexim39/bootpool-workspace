...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'first_pick', icon: 'flag', color: '#64ffda', label: 'First pick', desc: 'Published your first pick' },
  { id: 'rising_creator', icon: 'trending_up', color: '#0f86ff', label: 'Rising creator', desc: 'Published 5+ picks' },
  { id: 'veteran_creator', icon: 'military_tech', color: '#ffd166', label: 'Veteran creator', desc: 'Published 20+ picks' },
  ...
  { id: 'community_pick', icon: 'groups', color: '#4ecdc4', label: 'Community pick', desc: '5+ people staked on your picks' },
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, MatIconModule, MatButtonModule, MatProgressSpinnerModule, PodCardComponent, MobileNavComponent],
