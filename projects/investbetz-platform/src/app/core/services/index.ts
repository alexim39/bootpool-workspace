...
export type { WalletBalance, Transaction, TransactionHistoryResponse, WalletHistoryQuery, DepositInitResponse, WithdrawalInitResponse, Bank, AccountResolution, WithdrawalLimits, SavedBankAccount, RecipientMatch, TransferDirection, TransferRecord, TransferHistoryResponse, TransferQuery, TransferInitResponse } from './wallet.service';
