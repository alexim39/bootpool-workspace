...
@Component({
  ...
  templateUrl: './transfer-desktop.component.html',
  styleUrls: ['./transfer-desktop.component.scss']
})
export class TransferDesktopComponent implements OnInit {
  ...
  submitTransfer() {
    this.store.submitTransfer((msg) => this._snackBar.open(msg, 'OK', { duration: 5000 }));
  }
